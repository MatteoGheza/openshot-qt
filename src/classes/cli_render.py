...
class Bot():
	...
	def render(self, init_threads=True):
		...
		# generates xml file
		self.current_project.GenerateXML(os.path.join(self.USER_DIR, "westley.xml"))
		...
		self.file_name = os.path.join(self.USER_DIR, "westley.xml")
		...
		# set some consumer options
		self.c.set("rescale", "1" )
		self.c.set("distort", "1" )
		#self.c.set("progressive", 1)
